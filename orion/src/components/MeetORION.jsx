...
const MeetORION = () => {
  return (
    <section id="meet-orion" className="w-full flex flex-col items-center justify-center ">
      {/* Hero Image Container - Responsive sizing with new theme border and glow effect */}
      ...
      <div className="container mx-auto  px-6 sm:px-6 md:px-12 mt-12 sm:mt-16 md:mt-20">
        <div className="text-center max-w-6xl mx-auto my-7">
          {/* Main Heading - "Meet ORION — your dedicated Course Creator" */}
          <h2
          ...
          {/* Body Paragraph - Description of ORION */}
          <p
          ...
          >
            ...
            {/* <span className="bg-gradient-to-r from-lime-400 via-lime-500 to-lime-600 bg-clip-text text-transparent font-semibold">
              architect designed to transform educational concepts into professional, multi-
              format learning assets.
            </span>{" "} */}
            Powered by{" "}
