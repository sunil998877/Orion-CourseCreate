...
export const isStepComplete = (step: number, courseData: any, previewModules: any[], orionUrlByModule: Record<number, string>) => {
    switch (step) {
        case 1: {
            const baseComplete = !!(courseData.title?.trim() &&
