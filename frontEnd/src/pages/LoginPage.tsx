...
function App() {
    ...
    return (<PageTransition>
      <div className="relative min-h-screen overflow-auto animate-fade-in">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5 p-6 md:w-3/5 w-full">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input id="email" name="email" type="email" autoComplete="email" required value={formData.email} onChange={(e) => setFormData(prev => ({ ...prev, email: e.target.value }))} className={`
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input id="password" name="password" type={showPassword ? 'text' : 'password'} autoComplete="current-password" required value={formData.password} onChange={(e) => setFormData(prev => ({ ...prev, password: e.target.value }))} className={`
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <input id="remember-me" name="remember-me" type="checkbox" checked={formData.rememberMe} onChange={(e) => setFormData(prev => ({ ...prev, rememberMe: e.target.checked }))} className="h-4 w-4 rounded border-white/3 text-white focus:ring-white/5 bg-black"/>
        ...
        {modalMode !== 'none' && (<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-fade-in transition-all duration-300">
            <div className="relative w-full max-w-md rounded-2xl bg-zinc-950 border border-white/10 shadow-2xl p-6 md:p-8 animate-scale-in">
              ...
              <button type="button" onClick={() => setModalMode('none')} className="absolute top-4 right-4 text-white/50 hover:text-white transition-colors">
              ...
              {modalMode === 'forgot' ? (<form onSubmit={handleForgotSubmit} className="space-y-5">
                  ...
                  {forgotError && (<div className="rounded-md bg-red-500/10 p-3 border border-red-500/30 text-sm text-red-200">
                      {forgotError}
                    </div>)}

                  {forgotSuccessMessage && (<div className="rounded-md bg-emerald-500/10 p-3 border border-emerald-500/30 text-sm text-emerald-200">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input id="forgot-email" type="email" required value={forgotEmail} onChange={(e) => setForgotEmail(e.target.value)} className="block w-full rounded-lg border border-white/10 bg-black px-3 py-2.5 pl-10 shadow-sm text-white placeholder:text-gray-700 focus:border-lime-500/50 focus:outline-none focus:ring-1 focus:ring-lime-500/30 transition-all" placeholder="you@example.com"/>
                    </div>
                  </div>

                  <button type="submit" disabled={forgotIsLoading} className="w-full rounded-lg bg-gradient-to-r from-lime-400 to-emerald-500 py-3 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-lime-300 hover:to-emerald-400 disabled:opacity-50 font-semibold">
                ...
                </form>) : (<form onSubmit={handleResetSubmit} className="space-y-4">
                  <div className="space-y-1">
                  ...
                  {resetError && (<div className="rounded-md bg-red-500/10 p-3 border border-red-500/30 text-sm text-red-200">
                      {resetError}
                    </div>)}

                  {resetSuccessMessage && (<div className="rounded-md bg-emerald-500/10 p-3 border border-emerald-500/30 text-sm text-emerald-200">
                      {resetSuccessMessage}
                    </div>)}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input id="reset-email" type="email" required value={resetData.email} onChange={(e) => setResetData(prev => ({ ...prev, email: e.target.value }))} className="block w-full rounded-lg border border-white/10 bg-black px-3 py-2 pl-10 text-white placeholder:text-gray-700 focus:border-lime-500/50 focus:outline-none focus:ring-1 focus:ring-lime-500/30" placeholder="you@example.com"/>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input id="reset-token" type="text" required value={resetData.token} onChange={(e) => setResetData(prev => ({ ...prev, token: e.target.value }))} className="block w-full rounded-lg border border-white/10 bg-black px-3 py-2 pl-10 text-white placeholder:text-gray-700 focus:border-lime-500/50 focus:outline-none focus:ring-1 focus:ring-lime-500/30" placeholder="Enter 6-digit OTP code"/>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input id="reset-new-password" type={showResetPassword ? 'text' : 'password'} required value={resetData.newPassword} onChange={(e) => setResetData(prev => ({ ...prev, newPassword: e.target.value }))} className="block w-full rounded-lg border border-white/10 bg-black px-3 py-2 pl-10 pr-10 text-white placeholder:text-gray-700 focus:border-lime-500/50 focus:outline-none focus:ring-1 focus:ring-lime-500/30" placeholder="••••••••"/>
                      <button type="button" onClick={() => setShowResetPassword(!showResetPassword)} className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-white transition-colors">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input id="reset-confirm-password" type={showResetPassword ? 'text' : 'password'} required value={resetData.confirmPassword} onChange={(e) => setResetData(prev => ({ ...prev, confirmPassword: e.target.value }))} className="block w-full rounded-lg border border-white/10 bg-black px-3 py-2 pl-10 pr-10 text-white placeholder:text-gray-700 focus:border-lime-500/50 focus:outline-none focus:ring-1 focus:ring-lime-500/30" placeholder="••••••••"/>
                    </div>
                  </div>

                  <button type="submit" disabled={resetIsLoading} className="w-full rounded-lg bg-gradient-to-r from-lime-400 to-emerald-500 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:from-lime-300 hover:to-emerald-400 disabled:opacity-50 mt-2">
