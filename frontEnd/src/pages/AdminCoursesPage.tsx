            ...
            <tbody className="divide-y divide-slate-100 dark:divide-white/5">
              {courses.length > 0 ? (
                courses.map((course: any) => (
                  <tr key={course.id || course.courseId} className="hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-1.5">
                        {course.podcastStatus === "completed" && (
                          <span className="rounded bg-amber-500/10 px-1.5 py-0.5 text-[10px] font-semibold text-amber-600 dark:text-amber-400 border border-amber-500/20">
                            Podcast Ready
                          </span>
                        )}
                        ...
                        {course.modulesOverview?.some((m: any) => m.gammaUrl) && (
                          <span className="rounded bg-purple-500/10 px-1.5 py-0.5 text-[10px] font-semibold text-purple-600 dark:text-purple-400 border border-purple-500/20">
                            Slides Ready
                          </span>
                        )}
                      </div>
