...
const StepProgress: React.FC = () => {
  ...
  return (
      <div className="flex items-center justify-between mb-12 max-w-4xl mx-auto px-4 relative max-md:mb-14 max-md:px-0">
        {activeSteps.map((num) => (
          <div key={num} className="flex items-center flex-1 last:flex-none">
            <div className="relative group">
              ...
              >
                {step > num ? <Check size={20} strokeWidth={4} className="max-md:h-3.5 max-md:w-3.5" /> : (
