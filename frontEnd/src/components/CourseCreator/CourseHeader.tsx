...
const CourseHeader: React.FC = () => {
    ...
    return (
        <nav className="relative z-[100] py-4 px-8 border-b border-white/10 backdrop-blur-xl bg-black/40 max-md:px-3 max-md:py-3">
            <div className="w-full flex justify-between items-center transition-all duration-500">
                ...
                <div className="flex-1 flex items-center justify-end gap-6 max-md:gap-2">
                    ...
                    <motion.button
                        ...
                        className="md:hidden flex items-center justify-center h-10 w-10 rounded-xl border border-white/10 bg-white/5 text-lime-400"
                    >
