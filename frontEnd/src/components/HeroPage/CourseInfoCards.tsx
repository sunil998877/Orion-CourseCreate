...
export const CourseInfoCards: React.FC<{
    ...
    return (<div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
      {items.map((item, i) => (<div key={i} className="flex items-center gap-3 bg-white/10 p-4 rounded-lg hover:bg-white/20 hover:-translate-y-1 transition">
