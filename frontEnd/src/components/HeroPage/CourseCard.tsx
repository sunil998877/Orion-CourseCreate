  ...
  <div className="relative z-10">
    <div className="flex justify-between items-start mb-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <button type="button" aria-label="Delete course" onClick={e => { e.stopPropagation(); onDelete(); }} className="p-2.5 rounded-xl bg-red-500/5 hover:bg-red-500/20 text-red-400/40 hover:text-red-400 border border-transparent hover:border-red-500/20 transition-all active:scale-90">
