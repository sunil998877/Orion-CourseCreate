...
const GenerateAudioModal: React.FC<Props> = ({ courseTitle, progress, isGenerating, error, hasAudio, onGenerate, onListen, onClose, }) => {
    const stage = useMemo(() => {
