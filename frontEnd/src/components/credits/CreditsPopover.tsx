...
const CreditsPopover: React.FC<Props> = ({ credits, usagePercentage, usageHistory, onClose, onAddCredits, }) => {
    return (<div className="absolute bottom-full left-0 right-0 mb-2 z-50 rounded-xl border border-white/10 bg-[#0A0F1A]/95 backdrop-blur-xl shadow-2xl overflow-hidden animate-fadeInUp">
