    ...
    return (<div className="relative min-h-screen overflow-hidden animate-fadeIn">
      ...
      <div className="loader-overlay">
        <div className="wind-container">
          {streaks.map((s, i) => (<div key={i} className="streak" style={{
                width: `${s.width}px`,
                top: `${s.top}%`,
                left: '100%',
        ...
        {clouds.map((c, i) => (<div key={i} className="cloud" style={{
                width: `${c.size}px`,
      ...
      <div style={styles.container}>
        <div style={styles.content}>
          <DotLottieReact src="https://lottie.host/55a70a92-8774-43ae-860d-7e1dc379c936/7R7C2XMvP3.lottie" loop autoplay style={styles.animation}/>
          <p style={styles.text}>
