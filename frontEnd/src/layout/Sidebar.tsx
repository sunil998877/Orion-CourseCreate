...
export default function Sidebar() {
    ...
    return (
        <aside className="hidden md:flex md:flex-col fixed top-16 left-0 bottom-0 w-[250px] z-30 shrink-0 bg-[#101720]/95 border-r border-white/10 shadow-[12px_0_40px_rgba(0,0,0,0.12)]">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                key={item.path}
                                to={item.path}
                                className={`flex items-center gap-3 rounded-lg border px-3 py-2.5 font-medium transition-all ${isActive
