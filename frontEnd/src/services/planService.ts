...
export const subscribeToPlan = async (token: string, payload: PlanSubscribePayload): Promise<PlanSubscribeData> => {
...
export const createPlanStripeSession = async (token: string, payload: StripePlanSessionPayload): Promise<StripeSessionResponse> => {
