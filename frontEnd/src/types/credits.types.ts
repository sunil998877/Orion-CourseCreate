export type CreditAction = 'Generate Course Outline' | 'Generate Module' | 'Generate Lesson' | 'Generate Quiz' | 'Generate Questions' | 'Rewrite Content' | 'Generate Summary' | string;
