...
export default async function authenticateJWT(req, res, next) {
  ...
  // Clean token if wrapped in quotes, URI encoded, or includes Bearer prefix
  ...
  // Dev helper: allow ?dev=true in non-production for quick API testing without a token
