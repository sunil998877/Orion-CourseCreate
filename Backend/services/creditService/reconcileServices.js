    ...
    static async reconcile(
        ...
        try {
            await session.withTransaction(async () => {
                ...
                // Positive diff = refund excess back to balance
                // Negative diff = additional charge deducted from balance
                ...
                // Mark original reservation as RECONCILED if reservation object has _id
                if (reservation._id) {
