...
/**
 * POST /api/wallet/estimate/
 * Returns the credit cost for a given action_key before the user confirms.
 *
 * Body:
 *   { "action_key": "course_generation_gamma" }
 *
 * Response includes whether the user has enough credits.
 */
